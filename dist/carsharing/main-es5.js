(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AppComponent = /** @class */ (function () {
                function AppComponent(appConfigService, matIconRegistry, domSanitizer) {
                    var _this = this;
                    ...
                    ]).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(function (icon) { return appConfigService.socialIcons; }));
                    appConfigService.socialIcons.subscribe(function (icon) {
                        _this.addSvgIcon(icon.name);
                        _this.socialIcons.push(icon);
                    });
                }
                AppComponent.prototype.ngOnInit = function () {
                    throw new Error("Method not implemented.");
                };
                AppComponent.prototype.addSvgIcon = function (iconName) {
                    var _this = this;
                    this.appConfigService.getSvgFile("../assets/svg/" + iconName + ".svg").subscribe(function (element) {
                        console.log(element);
                        _this.matIconRegistry.addSvgIcon(element, _this.domSanitizer.bypassSecurityTrustResourceUrl("../assets/svg/" + element + ".svg"));
                    });
                };
                return AppComponent;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var IconBarComponent = /** @class */ (function () {
                function IconBarComponent(appConfigService) {
                    this.appConfigService = appConfigService;
                }
            ...
            IconBarComponent.ctorParameters = function () { return [
                { type: _services_app_config_service__WEBPACK_IMPORTED_MODULE_2__["AppConfigService"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AppConfigService = /** @class */ (function () {
                ...
                AppConfigService.prototype.configure = function (settings) {
                    // Assign transferred settings to that element from which method 'configure' was called.
                    Object.assign(this, settings);
                };
                AppConfigService.prototype.getSvgFile = function (filePath) {
